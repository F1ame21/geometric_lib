...
class RectangleTestCase(unittest.TestCase):
    def test_area_positive_value(self):
        ...
        self.assertAlmostEqual(area(4.5, 3.5), (4.5 * 3.5)/2, 2)
    ...
    def test_perimeter_positive_value(self):
        self.assertEqual(perimeter(10, 10, 10), 10 + 10 + 10)
        self.assertEqual(perimeter(3, 4, 5), 3 + 4 + 5)
        self.assertEqual(perimeter(4, 3, 2), 4 + 3 + 2)
        self.assertAlmostEqual(perimeter(4.5, 3.5, 2.5), 4.5 + 3.5 +2.5, 2)
    
    def test_perimeter_zero_value(self):
        self.assertRaises(ValueError, perimeter, 10, 0, 4)
        self.assertRaises(ValueError, perimeter, 0, 10, 5)

    def test_perimeter_negative_value(self):
        self.assertRaises(ValueError, perimeter, -1, 2, -3)
        self.assertRaises(ValueError, perimeter, 2, -3, -2)
        self.assertRaises(ValueError, perimeter, -3, 4, 2)
    
    def test_perimeter_types(self):
        self.assertRaises(TypeError, perimeter, 'abc', 12, '12')
        self.assertRaises(TypeError, perimeter, [123, 122], 'sad', 21)
        self.assertRaises(TypeError, perimeter, True, 1, False)
